...
![Study Together 使用虚拟数据运行的课程表](docs/images/study-together-course-schedule.png)

> 登录后截图于 2026-09-24 使用全新临时数据库、虚拟账号和三门虚拟课程生成。注册、登录、课程创建与课程表读取均通过本地实例实际完成，未配置第三方密钥，不含真实账号、Cookie 或私人数据。

![Study Together 本地运行的登录前首页](docs/images/study-together-landing.png)

> 登录前截图使用临时空数据库和未配置第三方密钥的本地实例生成。
